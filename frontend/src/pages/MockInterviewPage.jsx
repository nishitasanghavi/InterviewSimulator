...
import { Mic, Pause, ArrowRight, User, MessageSquare, BarChart3, Clock, Star, TrendingUp, AlertCircle } from 'lucide-react';
...
const MockInterviewPage = () => {
  ...
  const handleUserSubmit = async (e) => {
    ...
    setInterviewHistory(prev => [...prev, { role: 'candidate', content: userMessage }]);
    ...
    try {
      ...
      setInterviewHistory(prev => [...prev, { role: 'interviewer', content: data.interviewer_response }]);
      setQuestionCount(data.question_count);
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Get personalized feedback and improve your interview skills with our advanced AI interviewer
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8">
                ...
                <textarea
                  className="w-full h-40 p-4 border border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-none bg-white/50 backdrop-blur-sm"
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 overflow-hidden">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-purple-100">Question {questionCount}</p>
                    </div>
                  </div>
                  <button
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center mb-2">
                        <div className={`w-6 h-6 rounded-full mr-2 flex items-center justify-center text-xs font-semibold ${
                          message.role === 'interviewer' ? 'bg-gray-300 text-gray-700' : 'bg-white/20 text-white'
                        }`}>
              ...
              <div className="border-t border-gray-100 px-8 py-6 bg-gray-50/50">
                <div className="flex items-end space-x-4">
                  ...
                  <form onSubmit={handleUserSubmit} className="flex-1 flex space-x-4">
                    <input
                      type="text"
                ...
                <p className="text-xs text-gray-500 mt-3 text-center">
                  Speak naturally or type your responses • Say "exit" to finish the interview
                </p>
              </div>
            </div>
          </div>
        ...
        {interviewState === 'completed' && feedback && (
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-xl text-gray-600">Here's your personalized feedback and performance analysis</p>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 p-8 mb-8">
              <div className="text-center">
                <div className="inline-flex items-center justify-center w-32 h-32 bg-gradient-to-r from-purple-600 to-blue-600 rounded-full mb-6">
                  <span className="text-4xl font-bold text-white">{feedback.overall_score || feedback.overallScore}/10</span>
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Overall Performance</h3>
                <p className="text-gray-600">Great job! Here's how you performed across different areas.</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-2xl font-bold text-blue-600">{feedback.technical_score || feedback.technicalScore}/10</span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-3">
                  <div 
                    className="bg-gradient-to-r from-blue-500 to-blue-600 h-3 rounded-full transition-all duration-1000" 
                    style={{ width: `${((feedback.technical_score || feedback.technicalScore) / 10) * 100}%` }}
                  ></div>
                </div>
              </div>
              ...
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-2xl font-bold text-purple-600">{feedback.communication_score || feedback.communicationScore}/10</span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-3">
                  <div 
                    className="bg-gradient-to-r from-purple-500 to-purple-600 h-3 rounded-full transition-all duration-1000" 
                    style={{ width: `${((feedback.communication_score || feedback.communicationScore) / 10) * 100}%` }}
                  ></div>
                </div>
              </div>
              ...
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-2xl font-bold text-green-600">{feedback.fit_score || feedback.fitScore}/10</span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-3">
                  <div 
                    className="bg-gradient-to-r from-green-500 to-green-600 h-3 rounded-full transition-all duration-1000" 
                    style={{ width: `${((feedback.fit_score || feedback.fitScore) / 10) * 100}%` }}
                  ></div>
                </div>
              </div>
            </div>
