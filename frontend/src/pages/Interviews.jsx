  ...
  const pastInterviews = [
    {
      ...
      score: 85,
      feedback:
        "Great problem-solving approach. Could improve on communication.",
    },
    {
      id: 4,
      company: "Meta",
              ...
              <Card>
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 max-w-md mx-auto">
                    Schedule a mock interview to prepare for your next
                    opportunity.
                  </p>
                ...
                <Card key={interview.id}>
                  <div className="flex justify-between">
                    <div className="flex items-start gap-4">
                      <div
                        className={`w-12 h-12 ${interview.color} text-white flex items-center justify-center rounded-lg font-bold text-xl`}
                      >
                        {interview.logo}
                      </div>
                    ...
                    <div className="flex flex-col items-end justify-between">
                      ...
                      <div className="flex gap-2 mt-8">
                        ...
                        <button
                          className="bg-purple-600 text-white px-4 py-1.5 rounded-lg hover:bg-purple-700 transition-colors shadow-sm hover:shadow"
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span
                          className={`text-xs px-2 py-0.5 rounded-full ${getScoreBadgeColor(
                            interview.score
                          )}`}
                        >
